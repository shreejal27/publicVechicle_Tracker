            ...
            <div class="center-container">
                <div class="form-container mt-5 mb-5">
                    ...
                    <form class="form" action="#">
                        ...
                        <div class="input-group">
                            <label>Address</label>
                            <input type="text" value="{{ $admin['address'] }}" disabled>
                        </div>
                        <div class="input-group">
                            <label>Contact Number</label>
                            <input type="text" value="{{ $admin['contact_number'] }}" disabled>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="tab-pane fade" id="updateProfile" role="tabpanel" data-path="updateProfile">
            <div class="center-container">
                <div class="form-container mt-5 mb-5">
                    ...
                    <form class="form" action="{{ route('updateAdminProfile') }}" method="POST"
                        ...
                        <div class="input-group">
                            <label>Contact Number</label>
                            <input type="text" name="contact_number" value="{{ $admin['contact_number'] }}" required>
                        </div>
        ...
        <div class="tab-pane fade" id="changeCredentials" role="tabpanel" data-path="changeCredentials">
            <div class="center-container">
                <div class="form-container mt-5">
                    ...
                    <form class="form" id="userCredentialForm" action="{{ route('updateAdminCredentials') }}"
                        method="POST">
                        @csrf
                        <div class="input-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="cpassword" id="Cpassword"
                                value="{{ $admin['password'] }}"required disabled>
